package Service
//出现内存错误多考虑repartition .取前top_CCs(100)个可疑的团体，每个团体的前top_vs(10)个顶点上报
...
object SusCC_TopVs {
  ...
  def main(args: Array[String]) {
   ...
   //////////////////////过滤/////////////////////////////
    ...
    filtered_cc_rdd = filtered_cc_rdd.sortBy(f=>(f._6, f._7, f._10.toString().toLong, f._3, f._9.toString().toLong), false)  //maxDeg, BigKNum, money,ccNum,transCount
