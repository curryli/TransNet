...
//    val maxDegIn = ResultGraph.vertices.sortBy(_._2._2, false)   //按入度排序
//    val maxDegOut = ResultGraph.vertices.sortBy(_._2._3, false)   //按出度排序
//    //(id,(卡号,入度,出度,(总金额,总次数)))
